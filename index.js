...
// First, let's define some variables to keep track of the results
let totalMonths = 0;
let netTotal = 0;
let totalChange = 0;
let averageChange = 0;
...
for (let i = 0; i < finances.length; i++) {
    ...
    // Add the profit/loss for this month to the net total
    netTotal += finances[i][1];

    // If this is not the first month, calculate the change from the previous month
    if (i > 0) {
